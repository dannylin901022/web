...
function result() {
    if(document.getElementById('search_box').value != "" && document.getElementById('search_start').value != "" && document.getElementById('search_end').value != "" && document.getElementById('search_start').value < document.getElementById('search_end').value){
         display_all();
     setTimeout(function(){
            document.getElementById("loader").style.display = "none";
